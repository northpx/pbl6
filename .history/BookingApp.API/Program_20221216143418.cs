...
using System.Text;
using BookingApp.API.Repository;
...
services.AddSwaggerGen(options =>
{
    ...
    {
        Description = "Standar Authentication header using the Bearer scheme (\"{token}\")",
...
services.AddTransient<IRoomTypeRepository, RoomRepository>()
