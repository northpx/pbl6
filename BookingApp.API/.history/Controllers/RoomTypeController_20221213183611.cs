...
namespace BookingApp.BookingApp.API.Controllers
{
    ...
    public class RoomTypeController : ControllerBase
    {
        ...
        [HttpPost("add-roomtype"), Authorize(Roles ="Admin")]
        ...
        [HttpGet("list-roomtype"), Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        public async Task<IActionResult> GetAllRoomType(){
            var roomTypes = await _roomTypeRepository.RoomTypes.Select(x => new RoomType {Id = x.Id, Name = x.Name}).ToListAsync();
